  ...
  return (
    <div className="mx-auto max-w-3xl">
      <PageHeader
        ...
        description="O sistema lê a nota e cria a solicitação de compra preenchida — falta só a placa"
        action={
      ...
      <Card className="mb-4">
        <div className="space-y-2 p-5 text-sm text-slate-600">
          <p>
            Envie o PDF (ou a foto) da nota. O sistema lê e cria uma{" "}
          ...
          <p className="text-slate-500">
            ...
            nota duas vezes não duplica: o sistema avisa que ela já entrou.
          </p>
        </div>
      </Card>
