  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <p className="text-xs text-slate-500">
        Gera a <strong>conta a pagar</strong> desta entrada; o pagamento é feito pelo financeiro,
        indicando a conta. O custo da peça passa a ser a média entre o estoque atual e esta entrada.
      </p>
