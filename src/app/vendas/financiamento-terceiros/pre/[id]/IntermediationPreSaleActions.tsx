 ...
 *
 * A confirmação é um bloco na tela, não o `confirm` do navegador: no atalho
 * instalado no celular o diálogo nativo não abre, o clique volta como
 * "cancelar" e o botão parecia morto — nada acontecia e nada era explicado.
 */
export default function IntermediationPreSaleActions({
  ...
  return (
    <div className="mb-4 flex flex-wrap gap-3">
      ...
      {canRegister ? (
        <ConfirmButton
          question="Concluir a operação agora? A partir daqui os lançamentos financeiros serão gerados."
          confirmLabel="Registrar a operação"
      ...
      {canPreSale ? (
        <ConfirmButton
          question="Cancelar esta pré-venda? Ela não gerou nada no financeiro; será apenas removida."
          confirmLabel="Cancelar a pré-venda"
          cancelLabel="Manter"
