    ...
    <IntermediationContractDocument
      ...
      terceiro={
        sale.devolucaoPara === "TERCEIRO"
          ? {
              nome: sale.devolucaoTerceiroNome,
              documento: sale.devolucaoTerceiroDocumento,
              vinculo: sale.devolucaoTerceiroVinculo,
            }
          : null
      }
      ...
      debts={
        sale.debtsAmount
          ? {
              orgao: sale.debtsOrgao,
              descricao: sale.debtsDescricao,
              amount: sale.debtsAmount,
              barcode: sale.debtsBarcode,
              dueDate: sale.debtsDueDate,
            }
          : null
      }
