...
story += tela(
    ...
    [
        ...
        "<b>Quitação do financiamento anterior:</b> quando parte do valor financiado paga o boleto do "
        "banco credor do veículo, marque a opção na operação e informe banco, valor, código de barras "
        "e vencimento; anexe o boleto. Tudo consta na ficha e numa cláusula própria do contrato.",
